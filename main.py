...
from CipherBreaker.frequency_attack import break_vigenere, improve_key_by_word_score
...
def part2_break_cipher(ciphertext: str, language: str = "en"):
    ...
    for key_len in candidates[:5]:
        ...
        print("[*] Refining key...")
        improved_key, score = improve_key_by_word_score(ciphertext, key)

        v = VigenereCipher()
        v.set_key(improved_key)
        improved_plaintext = v.decode(ciphertext)
